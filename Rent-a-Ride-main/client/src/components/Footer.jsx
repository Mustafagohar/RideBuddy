      ...
      <div  className="bg-black text-white lg:pt-[100px] pb-[100px] p-10 rounded-none mt-[100px] lg:mt-[200px]" >
        <div className="w-full">
          <div className="grid  w-full justify-between lg:px-10 sm:flex sm:justify-between md:flex md:grid-cols-1 gap-y-10 pb-10">
            <div>
              <div className="py-2 mb-5 font-bold text-[18px] lg:text-[24px]"><h1>RideBuddy</h1></div>
            ...
            <div className="grid grid-cols-2 gap-8 sm:mt-4 sm:grid-cols-3 sm:gap-6 ">
              <div>
                ...
                <FooterLinkGroup col>
                  <FooterLink href="#">RideBuddy</FooterLink>
              ...
              <div>
                ...
                <FooterLinkGroup col>
                  <FooterLink href="https://github.com/Mustafagohar">Github</FooterLink>
          ...
          <div className="w-full sm:flex sm:items-center sm:justify-between lg:px-10 ">
            <FooterCopyright href="#" by="RideBuddy" year={2024} />
            <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
              <FooterIcon href="https://www.linkedin.com/in/mustafa-gohar-4a5289254/" icon={BsLinkedin} />
              <FooterIcon href="https://github.com/Mustafagohar" icon={BsGithub} />
